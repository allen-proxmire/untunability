...
*2026-09-14. A short version of* [*ED\_Interpretation\_Draft2.md*](ED_Interpretation_Draft2.md) *for readers without a physics background. Unfamiliar terms are explained in* [*Definitions.md*](Definitions.md)*.*
...
ED proved a small theorem about this:



* **If the rules look the same in a mirror,** handedness can't be written into those rules. If a world has a handedness, the state of the world picked it, the way a magnet picks a direction its laws don't prefer.
* **Handedness is only possible at all because time runs one way.**



The theorem is correct, and it's posted publicly with a script that checks it. Its mathematics is simple, and something close to it is already known.
...
* **Every failure recorded.** That includes mistakes in the test code itself.
* **Literature first.** Before claiming anything, published physics was checked to see whether someone had already done it.
* **Tuned settings labelled.** Any setting chosen just to make something work is marked as tuned.
* **An exit rule ahead of time.** "If three honest attempts fail, stop and write it up." 
...
* **The full write-up:** [ED\_Interpretation\_Draft2.md](ED_Interpretation_Draft2.md).
* **Definitions:** [Definitions.md](Definitions.md).
* **The public theorem:** https://github.com/allen-proxmire/event-density-streamlined
